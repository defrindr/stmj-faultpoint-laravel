...
@push('title', 'Ubah Siswa')
@push('header-title', 'Ubah Siswa')
...
<div class="col-md-12">
    ...
    <div class="card card-success">
        <div class="card-body">
            <form action="{{ route('siswa.update', [$kelas, $siswa]) }}" method="POST" class="form">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="alamat_rumah" id="alamat_rumah"
                        class="form-control">{{ $siswa->alamat_rumah }}</textarea>
                </div>
                <div class="form-group">
                    <label for="alamat_domisili">Alamat Domisili <span class="text-danger">*</span></label>
                    <textarea type="text" name="alamat_domisili" id="alamat_domisili"
                        class="form-control">{{ $siswa->alamat_domisili }}</textarea>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
